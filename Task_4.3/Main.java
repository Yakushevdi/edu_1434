...
class Cat {
    ...
    public boolean fight(Cat anotherCat) {
       if (this.age> anotherCat.age&&this.weight> anotherCat.weight) return true;
        else if (this.age> anotherCat.age&&this.strength> anotherCat.strength) return true;
        else if (this.weight> anotherCat.weight&&this.strength> anotherCat.strength)return true;
        else if (this.age==anotherCat.age&&this.weight== anotherCat.weight&&this.strength== anotherCat.strength) return true;
        else return false;
    }
}
